<?php
class GovernmentinviteeController  
{
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        if($_invitation_source){
                            ...
                            $participantTable->update(array('host_ID'=>$group_ID,'host_account_ID'=>$subscriber_ID,'invite_ID'=>$ID),$participant_ID);
    ...
    public static function participantConfirmedEmail($participant_data){
        ...
        $messageText_1= 'Your registration for the inaugural Transform Africa Summit 2018 in Kigali, Rwanda has been confirmed.';
