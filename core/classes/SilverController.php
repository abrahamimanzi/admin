                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        if($subscateg_data->plan!='Free'){
                            if ($payment_method == 'Debit/Credit Card') {
                                ...
                                $messageText_3='Your invoice for payment will be sent to you momentarily to process your payment by bank transfer or direct deposit. <br><br>Please contact us via enquiries@smartafrica.org, if you have not received your invoice within 48 hours.';
                        ...
                        $messageText_9= '<b>Collecting your badge</b>';

                        $messageText_10= 'You will be advised on the venue for badge collection. Ensure you bring the identification document you used in your registration process. Please note that your badge will only be issued once you have received your confirmation to attend the summit.';

                        // $messageText_16= 'You will be able to collect your badge from the 23rd of April 2018. Ensure that you bring the identification document you used in your registration process.';
