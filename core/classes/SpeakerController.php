...
//                            $reference_number = $code_string_0.'-'.Dates::get('Ymdhis');
                        ...
                        $subject= 'Thank you for your interest to speak at the Transform Africa Summit 2018';

                        $messageText_0= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.'</b>,';

                        $messageText_1= 'Thank you for expressing your interest in speaking at the Transform Africa Summit (Kigali, Rwanda, 8 – 11 May 2018).';
                        ...
                        $contactDetails['cc_email'] = 'enquiries@smartafrica.org';
