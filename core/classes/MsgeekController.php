...
class MsgeekController  
{
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        $contactDetails['from_names'] = 'Smart Africa Team';
                        $contactDetails['to_email'] = 'enquiries@smartafrica.org, girlsinict.rw@gmail.com, msgeekafrica@smartafrica.org';
    ...
    public static function participantConfirmedEmail($participant_data){
        ...
        $subject= 'Your registration confirmation for Transform Africa Summit 2017';

        $messageText_0= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

        $messageText_1= 'Your registration for the Transform Africa Summit 2017 (Kigali, Rwanda, 10 - 12 May 2017) has been confirmed.';
