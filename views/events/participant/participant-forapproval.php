              ...
              <div>
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed') $search_sql ");
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Participant();
                                ...
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed') $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                            ...
                            if(Input::checkInput('keyword','get','0') || strlen(Input::get('keyword','get'))<3){
                                ...
                                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`payment_state`='Confirmed' AND `state`!='Confirmed') $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
