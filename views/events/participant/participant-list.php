              ...
              <div>
                ...
                <div class="box">
                          ...
                          <thead>
                            <form method="post">
                              <tr>
                                ...
                                <th style="width: 90px"><button type="submit" name="sort-payment_state">Payment Status</button></th>
                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin'){?>
                                                            ...
                                                            <?php }?>
                                                            <li> 
                                                                <button class="menu" onclick="window.open('<?=DNADMIN?>/badge/<?=$participant_data->ID?>', 'newwindow', 'width=400, height=650'); return false;"><i class="fa fa-check-circle icon"></i> Badge</button>
                                                            </li>

                                                        <?php }?>

                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor' || $participant_data->category=='Government' || $participant_data->category=='Delegate request' || $participant_data->category=='Government request' || $participant_data->category=='Madia request')){?>
                                                            ...
                                                            <li> 
                                                                <button class="menu" name="payment-confirm" type="submit"><i class="fa fa-check-circle icon"></i> Confirm Invitetion </button>
                                                            </li>
                                                            <?php }?>
                                                            ...
                                                            <li> 
                                                                <button class="menu" name="payment-pending" type="submit"><i class="fa fa-check-circle icon"></i> Pending Invitetion</button>
                                                            </li>
                                                            <?php }?>
                                                        <?php }?>

                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'OGS-User') && ($participant_data->pass_type == 'Media' || $participant_data->category=='Madia request')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>

                                                            <?php if($participant_data->payment_state!='Confirmed' || ($participant_data->state!='Confirmed' AND $participant_data->category=='Media' AND $participant_data->payment_state!='Confirmed')){?>
                                                            <li> 
                                                                <button class="menu" name="payment-confirm" type="submit"><i class="fa fa-check-circle icon"></i> Confirm Invitetion </button>
                                                            </li>
                                                            <?php }?>
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor' || $participant_data->category=='Government')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User'){?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'Sessions-Admin'){?>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User'){?>
