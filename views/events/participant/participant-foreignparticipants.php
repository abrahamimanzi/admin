                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php
                            ...
                            $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`pass_type`='Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' || `pass_type` = 'Delegate' || `pass_type` = 'VVIP' || `pass_type` = 'VIP') AND `residence_country`!='Rwanda' AND `state`!=? AND `event_ID`=? $search_sql ",$sql_val_array);
